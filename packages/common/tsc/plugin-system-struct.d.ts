...
export declare type ViewPropsTransformerClass = new () => ViewPropsTransformer;
export interface ViewPropsTransformer {
    transform(viewProps: ViewProps, calendarProps: CalendarContentProps): any;
}
export declare type ViewContainerAppend = (context: CalendarContext) => ComponentChildren;
