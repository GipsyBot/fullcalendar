...
describe('timeGrid event rendering', function () {
    ...
    it('renders without intersecting when sorted by title', function () {
        ...
        var obscured = anyElsObscured(eventEls);
    ...
    it('renders event widths somewhat equally', function () {
        var calendar = initCalendar({
            initialView: 'timeGridDay',
        ...
        var timeGridWrapper = new TimeGridViewWrapper(calendar).timeGrid;
        var eventEls = timeGridWrapper.getEventEls();
        var eventWidths = eventEls.map(function (eventEl) { return eventEl.getBoundingClientRect().width; });
