    ...
    describeOptions('direction', {
        ...
        describe('when in month view', function () {
            ...
            it('gets fired correctly when the user selects cells', function (done) {
                ...
                dayGridWrapper.selectDates('2014-04-28', '2014-05-06').then(function () {
            ...
            it('gets fired correctly when the user selects cells via touch', function (done) {
                ...
                var calendar = initCalendar(options);
                var dayGridWrapper = new DayGridViewWrapper(calendar).dayGrid;
                dayGridWrapper.selectDatesTouch('2014-04-28', '2014-05-06').then(function () {
                    expect(options.select).toHaveBeenCalled();
                    done();
                });
            });
            it('gets fired correctly when the user selects just one cell', function (done) {
                ...
                var calendar = initCalendar(options);
                var dayGridWrapper = new DayGridViewWrapper(calendar).dayGrid;
                dayGridWrapper.selectDates('2014-04-28', '2014-04-28').then(function () {
                    expect(options.select).toHaveBeenCalled();
                    done();
                });
            });
        ...
        describe('when in week view', function () {
            ...
            describe('when selecting all-day slots', function () {
                it('gets fired correctly when the user selects cells', function (done) {
                    ...
                    dayGridWrapper.selectDates('2014-05-28', '2014-05-29').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
                it('gets fired correctly when the user selects a single cell', function (done) {
                    ...
                    var calendar = initCalendar(options);
                    var dayGridWrapper = new TimeGridViewWrapper(calendar).dayGrid;
                    dayGridWrapper.selectDates('2014-05-28', '2014-05-28').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
            ...
            describe('when selecting timed slots', function () {
                it('gets fired correctly when the user selects slots', function (done) {
                    ...
                    timeGridWrapper.selectDates('2014-05-28T09:00:00', '2014-05-28T10:30:00').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
                ...
                it('gets fired correctly when the user selects slots NEAR THE END', function (done) {
                    ...
                    var calendar = initCalendar(options);
                    var timeGridWrapper = new TimeGridViewWrapper(calendar).timeGrid;
                    timeGridWrapper.selectDates('2014-05-28T16:00:00', '2014-05-29T00:00:00').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
                it('gets fired correctly when the user selects slots via touch', function (done) {
                    ...
                    var calendar = initCalendar(options);
                    var timeGridWrapper = new TimeGridViewWrapper(calendar).timeGrid;
                    timeGridWrapper.selectDatesTouch('2014-05-28T09:00:00', '2014-05-28T10:30:00').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
                it('gets fired correctly when the user selects slots in a different day', function (done) {
                    ...
                    var calendar = initCalendar(options);
                    var timeGridWrapper = new TimeGridViewWrapper(calendar).timeGrid;
                    timeGridWrapper.selectDates('2014-05-28T09:00:00', '2014-05-29T10:30:00').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
                it('gets fired correctly when the user selects a single slot', function (done) {
                    ...
                    var calendar = initCalendar(options);
                    var timeGridWrapper = new TimeGridViewWrapper(calendar).timeGrid;
                    timeGridWrapper.selectDates('2014-05-28T09:00:00', '2014-05-28T09:30:00').then(function () {
                        expect(options.select).toHaveBeenCalled();
                        done();
                    });
                });
