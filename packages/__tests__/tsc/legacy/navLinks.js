...
describe('navLinks', function () {
    ...
    describeTimeZones(function (tz) {
        describe('in month view', function () {
            ...
            it('moves to day', function () {
                var dateClickSpy = spyOnCalendarCallback('dateClick');
            ...
            it('moves to two different days', function () {
                ...
                var dayGridWrapper2 = new DayGridViewWrapper(calendar).dayGrid;
            ...
            it('executes a custom handler', function () {
                var dateClickSpy = spyOnCalendarCallback('dateClick');
                var navLinkDayClickSpy = spyOnCalendarCallback('navLinkDayClick', function (date, ev) {
    ...
    describe('in listWeek', function () {
        ...
        it('moves to day view', function () {
            var dateClickSpy = spyOnCalendarCallback('dateClick');
            var calendar = initCalendar();
            var listWrapper = new ListViewWrapper(calendar);
