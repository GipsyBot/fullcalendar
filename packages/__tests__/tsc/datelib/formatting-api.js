...
describe('formatDate', function () {
    ...
    it('works with timezone offset', function () {
        var str = formatDate('2018-09-04T00:00:00-05:00', {
            month: 'long',
            day: 'numeric',
            year: 'numeric',
            timeZoneName: 'short',
...
describe('formatRange', function () {
    it('works with no timezone offset', function () {
        var str = formatRange('2018-09-04', '2018-10-04', {
            month: 'long',
            day: 'numeric',
            year: 'numeric',
        });
    ...
    it('works with timezone offset', function () {
        var str = formatRange('2018-09-04T00:00:00-05:00', '2018-10-04T00:00:00-05:00', {
            month: 'long',
            day: 'numeric',
            year: 'numeric',
            timeZoneName: 'short',
