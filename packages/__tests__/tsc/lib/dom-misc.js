export var RED_REGEX = /red|rgb\(255,\s*0,\s*0\)/;
export var GREEN_REGEX = /green|rgb\(0,\s*255,\s*0\)/;
export var BLUE_REGEX = /blue|rgb\(0,\s*0,\s*255\)/;
                ...
                compare: function (actual) {
                    ...
                    var result = {
                        pass: elm[0].scrollWidth - 1 > elm[0].clientWidth || // -1 !!!
                            elm[0].scrollHeight - 1 > elm[0].clientHeight,
                    };
