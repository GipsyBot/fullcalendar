...
describe('validRange', function () {
    ...
    describe('when one week view', function () {
        pushOptions({
        ...
        describe('when validRange is a function', function () {
            ...
            it('can return a range object with strings', function () {
                var validRangeSpy = spyOnCalendarCallback('validRange', function () { return ({ start: '2017-06-06' }); });
                initCalendar();
                expect(validRangeSpy).toHaveBeenCalled();
                expectRenderRange('2017-06-04', '2017-06-11');
                expectActiveRange('2017-06-06', '2017-06-11');
            ...
            it('can return a range object with Date objects', function () {
                var validRangeSpy = spyOnCalendarCallback('validRange', function () { return ({ start: parseUtcDate('2017-06-06') }); });
                initCalendar();
                expect(validRangeSpy).toHaveBeenCalled();
                expectRenderRange('2017-06-04', '2017-06-11');
                expectActiveRange('2017-06-06', '2017-06-11');
    ...
    describe('when a three-day view', function () {
        pushOptions({
